...
if (!isset($_GET['NIM'])) die("NIM not found.");
$NIM = $_GET['NIM'];
...
if (!$mhs) die("Student data not found.");
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="process_edit.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="Nama" name="Nama" class="form-input" value="<?= htmlspecialchars($mhs['Nama']) ?>" required>
                </div>
                <div class="form-group">
                    <label for="Alamat" class="form-label"><i class="fas fa-map-marker-alt"></i> Address</label>
                    <input type="text" id="Alamat" name="Alamat" class="form-input" value="<?= htmlspecialchars($mhs['Alamat']) ?>" required>
                </div>
