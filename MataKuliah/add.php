        ...
        <div class="form-container">
            ...
            <form action="process_add.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="KodeMatkul" name="KodeMatkul" class="form-input" placeholder="Enter subject code (e.g., CS101)" required>
                </div>
                <div class="form-group">
                    <label for="NamaMatkul" class="form-label"><i class="fas fa-book-open"></i> Subject Name</label>
                    <input type="text" id="NamaMatkul" name="NamaMatkul" class="form-input" placeholder="Enter subject name" required>
                </div>
                <div class="form-group">
                    <label for="SKS" class="form-label"><i class="fas fa-star"></i> Credits (SKS)</label>
                    <input type="number" id="SKS" name="SKS" class="form-input" placeholder="Enter credit hours" min="1" max="6" required>
                </div>
                <div class="form-group">
                    <label for="Semester" class="form-label"><i class="fas fa-calendar"></i> Semester</label>
                    <input type="number" id="Semester" name="Semester" class="form-input" placeholder="Enter semester number" min="1" max="8" required>
                </div>
